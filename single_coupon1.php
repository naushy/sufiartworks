...
<div class="two-third">
        ...
        <img title="" src="img/masonry/1.jpg" alt="" style="float:left; margin-right: 20px" />
        
        <h2 style="margin-top:0; margin-bottom:5px">Own & Snake Metaphor</h2>
      
        
        <p><strong>Description:</strong> Sun, Moon, Raag-Ragini Night (Symphony of Musical Night), Jodhpuri Rajwade(Rajput Kings of 18th century). Owl preying a Snake used as metaphor for social awareness, folk singer, rythm of colors perfectly describe the surroundings of 18th century. Warm colors are specially used to reflect the flavor of Suncity     </p>
        
        <p style="font-weight:bold">Price: $ 1200 | Coupon Price: $ 1000 </p>
  ...
  <input type="hidden" id="url_request" value="unlock_handler.php?url=<?PHP echo urlencode($share_url); ?>" />
      ...
      <?PHP endif; ?>
       ...
       <div style="clear:both"></div>
        ...
        <p>Ishaque Ahmed is famous artist from Suncity(Jodhpur, Rajasthan). Paintings, Photography(Macro & Micro), Serigraphy, Calligraphy and Philosophy are areas of his expertise.</p>
...
<br /><small><a href="http://www.google.co.in/maps/place/Gulab+Sagar,+Jodhpur,+Rajasthan+342001/@26.2981878,73.0264272,18z/data=!4m2!3m1!1s0x39418dba86fd39e1:0x766bf37d2f29168e!6m1!1e1">Jodhpur</a></small>
    ...
    <div style="clear:both"></div>
     <div id="social_icons" align="center"></br>Copyright &copy; 2016. All Rights Reserved </br>SufiArtworks By <a>Ishaque Ahmed</a>
          </div>
    </div> <!-- END footer -->
